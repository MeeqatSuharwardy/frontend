...
import portfoliobg from "../../data/portfolioBg.json"
    ...
    <section className="portfolio full-bg">
      ...
      <div className="glry-img">
        <div
          ...
          style={{ backgroundImage: `url(/assets/img/portfolio/full/kitchen2.png)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-2"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/furniture.png)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-3"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/living.png)` }}
          data-overlay-dark="2"
        ></div>
        <div
          id="tab-4"
          className="bg-img tab-img"
          style={{ backgroundImage: `url(/assets/img/portfolio/full/dining.png)` }}
          data-overlay-dark="2"
        ></div>
      </div>
    </section>
