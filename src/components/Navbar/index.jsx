        ...
        <div className="container">
          <Link href="/home">
            <a className={`logo ${logoClass && logoClass}`}>
              <img src={appData.newlogo} alt="logo" ref={logoRef} />
            </a>
          </Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto">
              ...
              <li className="nav-item dropdown" onClick={handleDropdown}>
                ...
                <div className="dropdown-menu">
                  <Link href="/Furniture-project-details">
                    <a className="dropdown-item">Furniture</a>
                  </Link>
                  <Link href="/Dining-project-details">
                    <a className="dropdown-item">Dining</a>
                  </Link>
                  <Link href="/Living-project-details">
                    <a className="dropdown-item">Living</a>
                  </Link>
                  <Link href="/kitchen-project-details">
                    <a className="dropdown-item">Kitchen</a>
                  </Link>
                  <Link href="/Bathroom-project-details">
                    <a className="dropdown-item">Bathroom</a>
                  </Link>
                  <Link href="/Bedroom-project-details">
